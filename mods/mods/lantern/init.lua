...
walkable = false,
light_source = LIGHT_MAX-1,
groups = {choppy=1,dig_immediate=3, attached_node=1},
sounds = default.node_sound_defaults(),
selection_box = {
		type = "fixed",
...
minetest.register_craft({
	...
	{'','lantern:fence_black',''},
	{'','lantern:lamp',''},
	{'lantern:fence_black','lantern:fence_black','lantern:fence_black'},
	}
})
...
minetest.register_craft({
	...
	recipe = {
	{'','','lantern:fence_black'},
	{'lantern:fence_black','lantern:lamp','lantern:fence_black'},
	{'','','lantern:fence_black'},
	}
})
