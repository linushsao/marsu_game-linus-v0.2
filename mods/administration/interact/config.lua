...
--The first screen--
--The text at the top.
interact.s1_header = "Hello, welcome to mars-server #1!"
...
interact.msg_grief = "Griefing is disallowed, if u do it u will get banned!."
...
interact.s4_question4_true = "Help."
interact.s4_question4_false = "Items."
