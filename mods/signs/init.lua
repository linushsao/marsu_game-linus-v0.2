...
minetest.register_node("signs:sign_yellow", {
    description = "Sign_with_TEXT_yellow",
    inventory_image = "signs_sign_yellow.png",
    wield_image = "signs_sign.png",
    stack_max = 1,
    node_placement_prediction = "",
    paramtype = "light",
    ...
    node_box = {type = "fixed", fixed = {-0.45, -0.15, 0.4, 0.45, 0.45, 0.498}},
    selection_box = {type = "fixed", fixed = {-0.45, -0.15, 0.4, 0.45, 0.45, 0.498}},
    tiles = {"signs_top.png", "signs_bottom.png", "signs_side.png", "signs_side.png", "signs_back.png", "signs_front_yellow.png"},
    walkable = false,
    groups = sign_groups,
    ...
    on_place = function(itemstack, placer, pointed_thing)
        ...
        if wdir == 0 then
            --how would you add sign to ceiling?
            minetest.env:add_item(above, "signs:sign_yellow")
            return ItemStack("")
        elseif wdir == 1 then
            minetest.env:add_node(above, {name = "signs:sign_yard_yellow", param2 = fdir})
            sign_info = signs_yard[fdir + 1]
        else
            minetest.env:add_node(above, {name = "signs:sign_yellow", param2 = fdir})
            sign_info = signs[fdir + 1]
        end
...
minetest.register_node("signs:sign_nice", {
    description = "Sign_with_TEXT_nice",
    inventory_image = "signs_sign_nice.png",
    wield_image = "signs_sign.png",
    stack_max = 1,
    node_placement_prediction = "",
    paramtype = "light",
    ...
    node_box = {type = "fixed", fixed = {-0.45, -0.15, 0.4, 0.45, 0.45, 0.498}},
    selection_box = {type = "fixed", fixed = {-0.45, -0.15, 0.4, 0.45, 0.45, 0.498}},
    tiles = {"signs_top.png", "signs_bottom.png", "signs_side.png", "signs_side.png", "signs_back.png", "signs_front_nice.png"},
    walkable = false,
    groups = sign_groups,
    ...
    on_place = function(itemstack, placer, pointed_thing)
        ...
        if wdir == 0 then
            --how would you add sign to ceiling?
            minetest.env:add_item(above, "signs:sign_nice")
            return ItemStack("")
        elseif wdir == 1 then
            minetest.env:add_node(above, {name = "signs:sign_yard_nice", param2 = fdir})
            sign_info = signs_yard[fdir + 1]
        else
            minetest.env:add_node(above, {name = "signs:sign_nice", param2 = fdir})
            sign_info = signs[fdir + 1]
        end
...
minetest.register_node("signs:sign_yard_yellow", {
    paramtype = "light",
    paramtype2 = "facedir",
    drawtype = "nodebox",
    node_box = {type = "fixed", fixed = {
...
minetest.register_node("signs:sign_yard_nice", {
    paramtype = "light",
    paramtype2 = "facedir",
    drawtype = "nodebox",
    node_box = {type = "fixed", fixed = {
