...
compost.register_item("marssurvive:base_material")

minetest.register_node("marssurvive:wood_barrel", {
...
minetest.register_node("marssurvive:wood_barrel_1", {
...
minetest.register_node("marssurvive:wood_barrel_2", {
	description = "Wood Barrel with compost",
...
minetest.register_node("marssurvive:wood_barrel_3", {
	description = "Wood Barrel",
...
minetest.register_abm({
	nodenames = {"marssurvive:wood_barrel_1"},
	interval = 5.0,
	chance = 3,
	action = function(pos, node, active_object_count, active_object_count_wider)
		minetest.set_node(pos, {name = "marssurvive:wood_barrel_2"})
	end,
})

minetest.register_abm({
	nodenames = {"marssurvive:wood_barrel_2"},
	interval = 5.0,
	chance = 3,
	action = function(pos, node, active_object_count, active_object_count_wider)
		minetest.set_node(pos, {name = "marssurvive:wood_barrel_3"})
	end,
})

minetest.register_craft({
	output = "marssurvive:wood_barrel",
	recipe = {
...
minetest.register_craftitem("marssurvive:base_material", {
    description = "Unfermented compost",
    inventory_image = "compost_base.png",
...
for i, name in pairs(plant_table) do
	...
	minetest.register_craft({
		output = "marssurvive:base_material 2",
		recipe = {
			{name, name,name },
			{name, name,name },
			{name, name,name }
	...
	minetest.register_craft({
		output = "marssurvive:base_material 1",
		recipe = {
			{'default:mossycobble'}
		}
	})
...
minetest.register_alias("compost:base_material", "marssurvive:base_material")
minetest.register_alias("compost:wood_barrel", "marssurvive:wood_barrel")
minetest.register_alias("compost:wood_barrel_1", "marssurvive:wood_barrel_1")
minetest.register_alias("compost:wood_barrel_2", "marssurvive:wood_barrel_2")
minetest.register_alias("compost:wood_barrel_3", "marssurvive:wood_barrel_3")
